    ...
    <div className="mb-5">
      ...
      <div className="flex justify-between items-center mb-4 space-x-2">
        ...
        <div className="flex items-center space-x-2">
          <FormControl variant="outlined" sx={{ minWidth: 120, backgroundColor: '#fff' }}>
          ...
          <div className="flex items-center space-x-2">
            <FormControl variant="outlined" sx={{ width: '45%' }}>
              <TextField
                ...
                onChange={(e) => setSelectedMinPrice(e.target.value ? parseInt(e.target.value, 10) : '')}
                fullWidth
                InputProps={{
                  inputProps: { min: 0 },
                }}
            ...
            <FormControl variant="outlined" sx={{ width: '45%' }}>
              <TextField
                ...
                onChange={(e) => setSelectedMaxPrice(e.target.value ? parseInt(e.target.value, 10) : '')}
                fullWidth
                InputProps={{
                  inputProps: { min: 0 },
                }}
